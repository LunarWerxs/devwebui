...
export default {
  ...
  processForm: {
    ...
    labelId: 'ID <span class="font-normal text-[#5c5c66]">· unique key</span>',
    placeholderId: "web",
    labelCommand: "Command",
    placeholderCommand: "bun run dev",
    labelCwd: 'Working directory <span class="font-normal text-[#5c5c66]">· optional</span>',
    placeholderCwd: "file location",
    labelPort: 'Port <span class="font-normal text-[#5c5c66]">· optional</span>',
    placeholderPort: "4173",
    labelUrl: 'Open URL <span class="font-normal text-[#5c5c66]">· optional</span>',
    placeholderUrl: "/path or https://…",
    labelWaitForPort: 'Wait for port <span class="font-normal text-[#5c5c66]">· optional</span>',
    placeholderWaitForPort: "4173 or another process's id",
    labelColor: 'Color <span class="font-normal text-[#5c5c66]">· optional</span>',
